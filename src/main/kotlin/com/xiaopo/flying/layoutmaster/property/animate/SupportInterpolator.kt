...
import com.xiaopo.flying.layoutmaster.refer.FastOutLinearInInterpolator
import com.xiaopo.flying.layoutmaster.refer.FastOutSlowInInterpolator
import com.xiaopo.flying.layoutmaster.refer.LinearOutSlowInInterpolator
...
object SupportInterpolator {
  ...
  init {
    ourSupportInterpolator["DecelerateInterpolator"] =
        of(DecelerateInterpolator::class.java,
    ...
    ourSupportInterpolator["AccelerateInterpolator"] =
        of(AccelerateInterpolator::class.java,
            linkedMapOf<String, Pair<PropertyType<*>, *>>(
                "Factor" to (PropertyType.Float to 1f)
            ))
