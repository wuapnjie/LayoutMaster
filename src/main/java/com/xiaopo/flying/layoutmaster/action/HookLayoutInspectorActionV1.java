 ...
 * @author wupanjie
 */
public class HookLayoutInspectorActionV1 extends AnAction {

    public HookLayoutInspectorActionV1() {
        super("Layout Master (V1, Slow but more info)", "Run Layout Inspector with Layout Master", null);
    }
    ...
    public void actionPerformed(@NotNull AnActionEvent anActionEvent) {
        ...
        if (dialog.getExitCode() == DialogWrapper.OK_EXIT_CODE) {
            ...
            if (client != null) {
                GlobalConfig.INSTANCE.setUseV2(false);
